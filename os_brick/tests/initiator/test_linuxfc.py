...
class LinuxFCTestCase(base.TestCase):
    ...
    def test_rescan_hosts(self):
        hbas = [{'host_device': 'host10', 'node_name': '0x20000000c9952b4c',
                 'port_name': '0x10000000c9952b4c'},
                {'host_device': 'host11', 'node_name': '0x20000000c9952b4c',
                 'port_name': '0x10000000c9952b4d'}]
